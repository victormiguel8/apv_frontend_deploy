           ...
           { msg && <Alerta alerta={alerta}/>}
            ...
            <form onSubmit={handleSubmit}>
                <div className='my-5'>
                    ...
                    <input type="text" placeholder='Tu Nombre' className='border w-full p-3 mt-3 bg-gray-100 rounded-xl' 
                ...
                <div className='my-5'>
                    ...
                    <input type="email" placeholder='Email de Registro' className='border w-full p-3 mt-3 bg-gray-100 rounded-xl'
                ...
                <div className='my-5'>
                    ...
                    <input type="password" placeholder='Tu Password' className='border w-full p-3 mt-3 bg-gray-100 rounded-xl'
